      ...
      <div class="kt-portlet__body kt-portlet__body--fit">
        <div class="kt-grid">
          <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
              <div class="card-header">{{ __('subscription.enter_code') }}</div>

              <div class="card-body">
                <form method="POST" action="{{ route('admin.subscriptionsverify.check') }}" enctype="multipart/form-data">
                    @csrf
