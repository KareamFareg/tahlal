...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
  ...
  <div class="kt-portlet">
    ...
    <!--begin::Form-->
    <form class="kt-form kt-form--label-right" action="{{ route('admin.items.index') }}" method="post">
          {{ csrf_field() }}
      ...
      <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
        ...
        <tbody>
          ...
          <tr id="{{ $item->item_id }}">
            <td>{{ $item->item_id }}</td>
            <td>
            <a href="{{ route('admin.items.edit' , [ 'id' => $item->item_id ] ) }}" class="kt-userpic kt-userpic--circle kt-margin-r-5 kt-margin-t-5" data-toggle="kt-tooltip" data-placement="right">
              <img src="{{ $item->item_image ? asset('storage/app/'.$item->item_image) : $emptyImage }}">&nbsp;{{ $item->item_title }}
            </a>
            </td>
