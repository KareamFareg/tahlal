...
<form class="kt_form_1" enctype="multipart/form-data"
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            ...
            value="{{ old('email' , $data->email ) }}" required autocomplete="email">
            @error('email')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <div class="form-group row">
      ...
      <div class=" col-lg-9">
        <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" required maxlength="11" name="mobile"
    ...
    <div class="form-group row">
      ...
      <div class=" col-lg-9">
        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" required maxlength="11" name="phone"
