...
<div class="row">
  ...
  <div class="col-md-6 offset-md-3">
    <h3>{{ __('verification.verification_page') }}</h3>
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('admin.verifications.check') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('admin.verifications.resend_code') }}" onclick="delaySeconds(30)">
                                {{ __('verification.resend_code') }} <span id="countdown">30</span> ثانية
                            </a>
                        </div>
                    </div>
                </form>
