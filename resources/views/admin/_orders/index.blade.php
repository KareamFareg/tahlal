...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
  ...
  <div class="kt-portlet">
    ...
    <!--begin::Form-->
    <form class="kt-form kt-form--label-right" action="{{ route('admin.orders.index') }}" method="post">
      {{ csrf_field() }}
      ...
      <div class="kt-portlet__body">
        <div class="form-group row">
          ...
          <div class="col-lg-3">
            ...
            <select class="form-control kt-select2 {{ $errors->has('status') ? ' is-invalid' : '' }}" id="kt_select2_3"
              name="status">
