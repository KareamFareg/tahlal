        ...
        <div class="kt-portlet__body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="kt_widget11_tab1_content">
                    ...
                    <!-- <a href="{{ route('admin.trader.addMine') }}" class=" btn btn-success " type="submit">
                                                    <i class="fa fa-pincel"></i>اضافه منتج جديد
                    </a> -->
                   </div>
                    <!--begin::Widget 11-->
                    <div class="kt-widget11">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <td style="width:30%">اسم المنتج</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal-footer">                                   
                                                <a href="{{ route('admin.souqProducts.edit' , ['id' => $data->id ]) }}" class=" btn btn-success " type="submit">
