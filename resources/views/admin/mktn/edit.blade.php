                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section kt-section--first">
                            ...
                            <form class="kt_form_1" enctype="multipart/form-data"
                                action="{{ route('admin.mktn.update',['id'=>$market->id]) }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-lg-4 col-md-9 col-sm-12">
                                        <input type="text"
                                            ...
                                            maxlength="100" value="{{$market->name}}" name="name" >
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3 col-sm-12"> المدينه *</label>
                                    <div class=" col-lg-4 col-md-9 col-sm-12">
                                        <input type="text"
                                            class="form-control {{ $errors->has('city') ? ' is-invalid' : '' }}" required
                                            maxlength="100" value="{{$market->city}}" name="city" >
                                        <!-- <span class="form-text text-muted">Please enter your full name</span> -->
                                        @if ($errors->has('city'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <img src="{{ $market->icon ? asset('storage/app/' . $market->icon) : $emptyImage }}" width="200" height="200">
