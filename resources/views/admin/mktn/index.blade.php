                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.mktn.shops' , ['id' => $data->id ]) }}" class=" btn btn-success " type="submit">
                                                    <i class="fa fa-pincel"></i>عرض المتاجر
                                                </a>                                
                                                <a href="{{ route('admin.mktn.edit' , ['id' => $data->id ]) }}" class=" btn btn-success " type="submit">
                                                    <i class="fa fa-pincel"></i>{{__('words.edit')}}
                                                </a>
                                                <a href="{{ route('admin.mktn.delete' , ['id' => $data->id ]) }}" class="btn btn-secondary"
