          ...
          <div class="kt-section kt-section--first">
            ...
            <form class="kt_form_1" enctype="multipart/form-data" action="{{route('admin.roles.store')}}" method="post">
              ...
              <div class="form-group row">
                ...
                <div class=" col-lg-4 col-md-9 col-sm-12">
                  <input type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" required
                    maxlength="100" value="{{ old('title') }}" name="title" placeholder="{{ __('role.name') }}">
              ...
              <div class="form-group row">
                ...
                <div class=" col-lg-4 col-md-9 col-sm-12">
                  <input type="number" class="form-control {{ $errors->has('level') ? ' is-invalid' : '' }}" required
                    maxlength="100" value="1"  min="1" name="level" placeholder="{{ __('role.level') }}">
                  <!-- <span class="form-text text-muted">Please enter your full name</span> -->
                  @if ($errors->has('level'))
        ...
        <div class="col-lg-9 col-md-9 col-sm-12">
          <div class="kt-checkbox-list">
            ...
            <div style="padding-right: {{ $privilege->depth * 25 }}px;margin: 13px;">
              <label class="kt-checkbox">
              <input type="checkbox" value="{{ $privilege->id }}" onclick="markChecked($(this),'{{$privilege->id}}')" class="parent_id_{{$privilege->parent_id}} role_id_{{$privilege->id}}" name="privileges_ids[]">{{ $privilege->title }}
                <span></span>
              </label>
            </div>
            @endforeach
