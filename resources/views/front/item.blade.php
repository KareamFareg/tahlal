  ...
  <div class="container">
    <div class="card shadow-sm bg-white">
      <ul class="list-unstyled no-margin">
        <li class="active"><a href="{{ route('front.home') }}"><img src="{{ asset('assets/images/select-all.svg') }}" class="img-fluid" alt="icon"> عرض الكل</a></li>
        <li><a href="{{ route('front.offers') }}"><img src="{{ asset('assets/images/discount.svg') }}" class="img-fluid" alt="icon"> عروض</a></li>
        <li><a href="{{ route('front.coupons') }}"><img src="{{ asset('assets/images/coupon.svg') }}" class="img-fluid" alt="icon">كوبونات</a></li>
      </ul>
    </div>
  </div>
</div>
